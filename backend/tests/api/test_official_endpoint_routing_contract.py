...
EXPECTED_VIEW_CLASSES = {
    ...
    ("POST", "/api/v1/auth/password-reset/request"): "PasswordResetRequestView",
    ("POST", "/api/v1/auth/password-reset/confirm"): "PasswordResetConfirmView",
    ("POST", "/api/v1/retrieval/ingest"): "RagIngestView",
    ("POST", "/api/v1/retrieval/search"): "RagSearchView",
